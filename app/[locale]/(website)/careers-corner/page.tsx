					...
					<FadeIn direction="right">
						<div>
							...
							<p className="text-muted-foreground">
								...
								Over the last 3 years, she has designed, elevated and
								contributed to build products for thousands of users in
								different sectors like Web3, Fintech, Health, Education, Beauty,
								Logistics, Community and Gaming.
							</p>
