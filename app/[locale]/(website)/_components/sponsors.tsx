	...
	return (
		<section className="py-10 pb-0 sm:pb-10 my-6 lg:my-8">
			...
			<div className="relative w-full overflow-hidden py-6 sm:py-8">
				<div className="absolute left-0 top-0 h-full w-10 sm:w-16 bg-linear-to-r from-white to-transparent z-10 pointer-events-none" />
				<div className="absolute right-0 top-0 h-full w-10 sm:w-16 bg-linear-to-l from-white to-transparent z-10 pointer-events-none" />

				<div className="flex overflow-x-hidden w-[200%] md:w-auto relative group">
					<div className="animate-marquee whitespace-nowrap min-w-fit group-hover:paused">
					...
					<div className="absolute top-0 left-0 animate-marquee2 whitespace-nowrap min-w-fit group-hover:paused">
						{SPONSORS_LIST.map((sponsor, index) => (
							<span
								key={`second-${index + 1}`}
								className="inline-block mx-2 sm:mx-4 md:mx-6 lg:mx-8"
