		...
		>
			...
			<div
				...
				style={{
					...
					borderRadius: "50%",
					background:
						"radial-gradient(circle, rgba(236,0,140,0.08) 0%, transparent 70%)",
					pointerEvents: "none",
				}}
			/>
			<div
				...
				style={{
					...
					borderRadius: "50%",
					background:
						"radial-gradient(circle, rgba(3,6,92,0.06) 0%, transparent 70%)",
					pointerEvents: "none",
				}}
			/>
			...
			<div
				style={{
					...
					boxShadow:
						"0 8px 40px rgba(236,0,140,0.08), 0 2px 8px rgba(3,6,92,0.06)",
					padding: "40px 36px",
					position: "relative",
					overflow: "hidden",
				}}
			>
				...
				>
					Mark this browser as a staff device so your visits are excluded from
				...
				>
					<span
						style={{
							...
							flexShrink: 0,
							boxShadow:
								mounted && isStaff ? "0 0 0 3px rgba(236,0,140,0.2)" : "none",
							transition: "all 0.3s ease",
