import Forherfirka from "@/app/(website)/about/assets/iphone-mockup.png";
	...
	return (
		<section className="bg-gradient-to-br from-pink-100 via-purple-50 to-pink-100 w-full py-16 md:py-24 relative overflow-hidden">
			...
			<div className="container mx-auto px-4 relative">
				<h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-gray-700 font-bold text-center mb-12 md:mb-16">
					Core Values
				</h1>
